...
public class DeclineCommand extends LupoCommand {
    ...
    public void onCommand(CommandContext context) {
        ...
        if (issue != null) {
            if (issue.hasDeclined(context.getMember())) {
                sendSyntaxError(context, "issuetracker_decline-already-done", issue.getId());
                return;
            } else if (issue.hasApproved(context.getMember())) {
                sendSyntaxError(context, "issuetracker_decline-already-approved", issue.getId());
                return;
            }
            ...
            issue.decline(context.getMember(), message, false);
        } else {
