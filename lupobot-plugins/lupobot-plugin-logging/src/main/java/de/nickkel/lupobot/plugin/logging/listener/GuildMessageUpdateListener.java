...
public class GuildMessageUpdateListener extends ListenerAdapter {
    ...
    public void onGuildMessageUpdate(@NotNull GuildMessageUpdateEvent event) {
        ...
        builder.addField(server.translate(plugin, "logging_messageupdate-channel"), event.getChannel().getAsMention()
                + " (" + event.getChannel().getId() + ")", false);
        builder.addField(server.translate(plugin, "logging_messageupdate-messageid"), event.getMessageId(), false);
        builder.addField(server.translate(plugin, "logging_messageupdate-oldmessage"), "Soon", false);
        builder.addField(server.translate(plugin, "logging_messageupdate-newmessage"), event.getMessage().getContentDisplay(), false);
